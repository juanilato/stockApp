...
export default function ModalQR({ visible, onClose, qrData, producto, variante }: Props) {
...
const renderContenidoQR = () => {
  try {
    ...
    return (
      <>
        <Text style={{ color: 'red' }}>⚠️ Error en QR</Text>
        <Text style={{ color: '#64748b' }}>{qrData}</Text>
      </>
    );
  }
};
